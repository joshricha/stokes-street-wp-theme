...
<section id="text-slider">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="box-border-grey"><p class = "thecontent slide1"><?php echo $slide_1_quote; ?></p>
                <p class = "thecontent slide2" style = "display: none;"><?php echo $slide_1_quote_2; ?></p></div>
            </div><!-- col -->
            <div class="col-md-4">
                <div class="box-border-grey"><p class = "thecontent2 slide3"><?php echo $slide_2_quote_1; ?><br><br>
                <span class="statistic"><?php echo $slide_2_quote_1_percentage; ?></span></p>
                <p class="thecontent2 slide4"  style = "display: none;"><?php echo $slide_2_quote_2; ?><br><br>
                <span class="statistic"><?php echo $slide_2_quote_2_percentage; ?></span></p></div>
            </div><!-- col -->
            <div class="col-md-4">
                <div class="box-border-grey"><p class = "thecontent3 slide5"><?php echo $slide_3_quote; ?><br><br>
                <span class="statistic"><?php echo $slide_3_quote_1_percentage; ?></span></p>
                <p class="thecontent3 slide6"  style = "display: none;"><?php echo $slide_3_quote_2; ?><br><br>
                <span class="statistic"><?php echo $slide_3_quote_2_percentage; ?></span></p></div>
            </div><!-- col -->
        </div><!-- row -->
    </div><!-- container -->
</section><!-- text slider -->